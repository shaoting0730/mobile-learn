            ...
            loginTag == 0 ?
              <View className='login_input_view'>
                <View className='input_name'>
                  <Input value={loginTel} onInput={(e) => this.loginTelChange(e.detail.value)}
                    placeholder='请输入手机号'
                  ></Input>
                </View>
                {
                  loginMode == 0 ?
                    <View className='input_code'>
                      <Input value={loginCode} onInput={(e) => this.loginCodeChange(e.detail.value)}
                        placeholder='请输入验证码'
                      ></Input>
                      <Text
                    ...
                    <View className='input_psw'>
                      <Input value={loginPsw} onInput={(e) => this.loginPswChange(e.detail.value)}
                        placeholder='输入密码'
                      ></Input>
                    </View>
                }
              ...
              <View className='login_input_view'>
                <View className='input_name'>
                  <Input value={registerTel} onInput={(e) => this.registerTelChange(e.detail.value)}
                    placeholder='请输入手机号'
                  ></Input>
                </View>
                <View className='input_code'>
                  <Input value={registerCode} onInput={(e) => this.registerCodeChange(e.detail.value)}
                    placeholder='请输入验证码'
                  ></Input>
                ...
                <View className='input_psw'>
                  <Input value={registerPsw} onInput={(e) => this.registerPswChange(e.detail.value)}
                    placeholder='输入密码'
                  ></Input>
                </View>
                <View className='input_psw'>
                  <Input value={registerPswAgain} onInput={(e) => this.registerPswAgainPswChange(e.detail.value)}
                    placeholder='再次输入密码'
                  ></Input>
                </View>
              </View>
